...
export interface ApiCarruselCarrusel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    c_vista: Schema.Attribute.Media<
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    p_color: Schema.Attribute.String;
    p_desc: Schema.Attribute.Text;
    p_imagen: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    p_precio: Schema.Attribute.Decimal;
    p_talla: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
